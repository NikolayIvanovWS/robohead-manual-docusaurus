...
Распознаванием ключевых слов занимается ROS-нода [~kws_recognizer](../10-introduction/47-voice-recognizer-pocketsphinx.md#основные-возможности-ros-node-voice-pocketspinx). Далее будет приведен пример смены ключевой фразы по умолчанию `Слушай, Робот!` на `Эй, Голова!`
